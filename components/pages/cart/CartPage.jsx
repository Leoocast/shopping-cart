...
export const CartPage = () => {
    ...
    const { cart, getTotalItems, removeItem, updateQuantity } = useCart()
            ...
            <div className="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5 rounded-lg
                ...
                <div className="flex justify-between border-b pb-8">
                    ...
                    <h2 className="font-semibold text-2xl">
                        {currencyFormat(totalItems)} {totalItems > 1 ? 'Productos' : 'Producto'}
                    </h2>
                </div>
                <div className="flex-1">
                    <table className="w-full text-sm lg:text-base" cellSpacing="0">
                        ...
                        <tbody>
                          {cart.map(item => <CartItem onChangeQuantity={customQuantityChange} onClickRemove={handleRemoveItem(item.id)} key={item.id} {...item}/>)}
                        </tbody>
                    </table>
                    ...
                    <div className="my-4 mt-6 -mx-2 lg:flex">
                        <div className="lg:px-2 lg:w-1/2">
                                    ...
                                    <form action="" method="POST">
                                        <div
                                            ...
                                            <button type="submit"
                                                ...
                                                <svg aria-hidden="true" data-prefix="fas" data-icon="gift" className="w-8"
                            ...
                            <div className="p-4">
                                <p className="mb-4 italic">If you have some information for the seller you can leave them in
                                    the box below</p>
                        ...
                        <div className="lg:px-2 lg:w-1/2">
                            ...
                            <div className="p-4">
                                <p className="mb-6 italic">Shipping and additionnal costs are calculated based on values you
                                    have entered</p>
